      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 16px' }}>
          ...
          <div style={{ border: '3px solid #1A1A1A', borderRadius: 18, overflow: 'hidden', boxShadow: '4px 4px 0 #1A1A1A' }}>
            ...
            <div style={{ padding: '28px 32px', background: '#EEEADE' }}>
              ...
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                {arch.traits.map((t, i) => (
                  <span key={i} style={{ padding: '6px 14px', border: '2px solid #1A1A1A', borderRadius: 12, background: '#fff', fontFamily: "'Press Start 2P', monospace", fontSize: 8, letterSpacing: 1 }}>{t}</span>
                ))}
              </div>
            </div>
          </div>
        ...
        <div style={{ textAlign: 'center', marginBottom: 60, display: 'flex', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            style={{ display: 'inline-block', fontWeight: 600, fontSize: 14, background: '#EEEADE', border: '3px solid #1A1A1A', borderRadius: 18, padding: '14px 28px', boxShadow: '4px 4px 0 #1A1A1A', textDecoration: 'none', color: '#1A1A1A', fontFamily: "'IBM Plex Mono', monospace" }}
          >
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{ background: '#FAF7F0', border: '3px solid #1A1A1A', borderRadius: 18, padding: '24px 32px', marginBottom: 40 }}>
